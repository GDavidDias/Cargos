...
console.log('que tiene datosInscripto en PaginaDesignacion: ', datosInscripto);
    ...
    function leyendaMovimiento(tipoMovimiento){
        let datamov='';
        if(datosInscripto.observacion == 'REINCORPORACION'){
            datamov='REINCORPORACION';
        }else{
            if(tipoMovimiento===1){
            ...
            <div>
                <div className='flex flex-col items-start'>
                    ...
                    <div className='flex flex-row'>
                        ...
                        <p className='border-b-[1px] border-black border-dotted w-[100px] text-center'>{(datosInscripto.observacion == 'REINCORPORACION') ?'---' :datosInscripto.cargo_actual} </p>
                    ...
                    <div className='flex flex-row mt-[2px]'>
                        ...
                        */}
                        <p className='ml-2 font-medium'>Apellido y Nombres:</p> 
                        <p className='border-b-[1px] border-black border-dotted w-[400px] text-center'>{datosInscripto.nombre} </p>
                    </div>
                    
                    <div className='flex flex-row mt-[2px]'>
                        <p className='ml-2 font-medium'>Institucion de Origen:</p>
                        <p className='border-b-[1px] border-black border-dotted w-[300px] text-center'>{(datosInscripto.observacion == 'REINCORPORACION') ?'---' :datosInscripto.nro_escuela}</p>
                    </div>
                    ...
                    <div className='flex flex-row'>
                        ...
                        */}
                        ...
                        <p className='border-b-[1px] border-black border-dotted w-[170px] text-center'>{leyendaMovimiento(datosInscripto.id_tipo_inscripto)}</p>
                        <p className='ml-2 font-medium'>Modalidad:</p>
                        <p className='border-b-[1px] border-black border-dotted w-[80px] text-center'>{(datosVacante.modalidad) ?datosVacante.modalidad :`--------------`}</p>
                        <p className='ml-2 font-medium'>Cargo de Destino:</p>
                        <p className='border-b-[1px] border-black border-dotted w-[150px] text-center'>{datosVacante.cargo}</p>
                    </div>
                    <div className='flex flex-row mt-[2px]'>
...
export default PaginaDesignacionMov;