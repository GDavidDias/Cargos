...
const ContentModalVacantesDispTit = ({datosInscriptoSelect,submitCloseModalVac,listadoVacantesDispTit,currentPageVac,paginacionVac,handlePageChangeVac,inputSearchVac,handleInputSearchVacChange,handleCancelSearchVac,submitVerAsignacion, listadoEspecialidades, filtroEspecialidadVac, handleSelectFiltroEspecialidadVac, handleCancelFiltroEspecialidadVac, estadoAsignadoInscripto, setEstadoAsignadoInscripto, HandleSelectEstadoAsignadoInscripto, submitGuardarEstadoInscripto, submitEliminarSubFiltros, handleSelectFiltroRegion, filtroRegionVac, handleCancelFiltroRegionVac, handleSelectFiltroModalidad, filtroModalidadVac, handleCancelFiltroModalidadVac, habilitaAsigna}) =>{
    return(
        <div className="notranslate h-100 w-100 flex flex-col items-center">
            ...
            <div className="flex flex-col justify-center  font-bold text-xl">
                ...
                <div className="flex flex-row">
                    <div className="border-[1px] border-zinc-300 rounded-md shadow justify-center">
                    ...
                    <div className="ml-2 flex flex-row items-center r">
