const ContentModalVerDatosVacanteMov = ({idVacante,formVacante,closeModal,handleChangeFormVacante,estadoForm,datosVacante,submitGuardarFormVacante,inscriptoAsignado, userSG}) =>{
    //console.log('ingreso a ContentModalVerDatosVacanteMov');
    ...
    return(
        <div className="notranslate h-100 w-100  flex flex-col items-center">
            ...
            <label className={`
                ${(inscriptoAsignado.id_inscripto_mov)
            ...
            <div>
                ...
                {(inscriptoAsignado.id_inscripto_mov && userSG.permiso!=3) &&
...
export default ContentModalVerDatosVacanteMov;