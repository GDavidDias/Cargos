...
const VisorAsignacionesMov = () => {
    ...
    const traigoAsignacionesRealizadas = async () => {
        ...
        try {
            ...
            console.log('que trae res de getAsignacionesMov: ', res.data);
    ...
    return (
        <div className="notranslate">
            ...
            >
                ...
                <div className="w-[15vw] h-[78vh] border-[1px] border-red-500">
                    {/**TITULO */}
                    <div>
                        ...
                        {asignaciones.map((asig, idx) => (
                            ...
                            >
                                ...
                                <p className="font-semibold text-xs">
                                    Docente: {asig.nombre_docente || asig.nombre}
                                </p>
                                <p className="text-xs">
                                    DNI: {asig.dni}
                                </p>
                                ...
                                <p className="text-[11px] text-zinc-500">
                                    Escuela: {asig.establecimiento_destino || 'N/D'}
                                </p>
                            </div>
                        ))}
                    </div>
                ...
                <div className="w-[70vw] h-[78vh] border-[1px] border-blue-500">
                    {/**VISOR DE ASIGNACIONES */}
                    <div className="m-4 h-[74vh] border border-zinc-400 rounded bg-zinc-50 shadow-md p-4 flex items-center justify-center">
                        {mostrarDetalle && ultimaAsignacion ? (
                            ...
                            <div className="w-full h-full flex flex-col justify-start">
                                ...
                                <div className="flex flex-col gap-x-6 gap-y-2 text-xl">
                                    {/**DATOS DEL DOCENTE ASIGNADO */}
                                    <div className="flex flex-row border-[2px] bg-blue-50 border-sky-400 rounded-md p-2 shadow-md w-[95%]">
                                        <div className="flex flex-col">
                                            <span className="font-semibold">Docente: </span>
                                            <span className="px-2 border-[1px] border-zinc-500 rounded-md w-[350px] bg-white">{ultimaAsignacion.nombre_docente || ultimaAsignacion.nombre}</span>
                                        </div>
                                    ...
                                    <div className="flex flex-row justify-between w-[100%]">
                                        ...
                                        {/**CARGO DESTINO*/}
                                        <div className="flex flex-col bg-green-100 border-[4px] border-green-400 rounded-md p-2 shadow-md w-[48%]">
                                            <div className="flex justify-center">
                                                <span className="font-bold text-lg mb-2 justify-center">CARGO DESTINO</span>
                                            </div>
                                            <div className="flex flex-col items-end">
                                                <div className="ml-2 mb-2 flex flex-row">
                                                    <span className="font-semibold">Escuela: </span>
                            ...
                            <p className="text-base text-4xl text-red-600 italic blink">
...
export default VisorAsignacionesMov;
