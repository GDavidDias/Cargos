    ...
    return(
        <div className=" notranslate h-full w-full ">
                ...
                <div className="desktop:w-[60vw] flex desktop:flex-col desktop:justify-center desktop:items-start  movil:flex-row movil:w-full movil:items-center movil:justify-center ">
                    ...
                    <div className="flex flex-col">
                        <div className="flex flex-row mb-2">
                            <label className="ml-4 text-lg font-sans font-bold">LISTADO DE VACANTES</label>
                            {/*(userSG.permiso!=3) &&
                                <button 
            ...
            <div className="h-[87vh] flex flex-col items-center">
                <div className="desktop:h-[73vh] movil:h-[72vh] m-2 desktop:border-[1px] border-[#758C51] rounded desktop:w-[83vw] movil:w-[99vw]">
                    {/* PARTE SUPERIOR DE TABLA */}
                    <div className="border-b-[1px] border-slate-300 desktop:h-[6vh] flex desktop:flex-row desktop:items-center movil:h-[7vh] movil:flex-row movil:items-start">
                        {/* Filtros */}
                        {/**
